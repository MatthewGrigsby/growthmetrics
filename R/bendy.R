...
#' @param hist.lngth The length of known history for the observed process. We use leave one-curve out cross validation for prediction (hist.lgth is 7 for example dataset).
#'
...
#'
#' @export
bendy <- function(data=HAZ, time=0:15, hist.lgth=7){
